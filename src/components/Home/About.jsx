...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: `ACG Autocentre are also sponsors of a local non-league football team, in which I have an interest, and it's great to see the mutual support between two, Nottingham-based businesses. Would have no hesitancy in visiting again and highly recommend!`,
    name: "Yadger",
  },
